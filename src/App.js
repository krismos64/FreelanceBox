            ...
            children: [
              _jsxs(Routes, {
                children: [
                  ...
                  _jsxs(Route, {
                    element: _jsx(PrivateRoute, { children: _jsx(Layout, {}) }),
                    children: [
                      _jsx(Route, {
                        path: "/dashboard",
                      ...
                      _jsx(Route, {
                        path: "/planning",
                        element: _jsx(Planning, {}),
                      }),
                      _jsx(Route, {
                        path: "/quotes",
                        element: _jsx(QuoteList, {}),
                      }),
                      _jsx(Route, {
                        path: "/quotes/new",
                        element: _jsx(CreateDocument, { type: "quote" }),
                      }),
                      _jsx(Route, {
                        path: "/quotes/:id/edit",
                        element: _jsx(EditDocument, { type: "quote" }),
                      }),
                      _jsx(Route, {
                        path: "/invoices",
                        element: _jsx(InvoiceList, {}),
                      }),
                      _jsx(Route, {
                        path: "/invoices/new",
                        element: _jsx(CreateDocument, { type: "invoice" }),
                      }),
                      _jsx(Route, {
                        path: "/invoices/:id/edit",
                        element: _jsx(EditDocument, { type: "invoice" }),
                      }),
                      _jsx(Route, {
                        path: "/clients",
                      ...
                      _jsx(Route, {
                        path: "/checklist",
                        element: _jsx(ChecklistPage, {}),
                      }),
                      _jsx(Route, {
                        path: "/company",
                        element: _jsx(CompanyPage, {}),
                      }),
                    ],
                  }),
                  _jsx(Route, {
